...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('home') }}">
        ...
        <div class="sidebar-brand-text mx-3">Serwu<sup>San</sup></div>
    </a>
    ...
    <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="#">Opłacone</a>
                <a class="collapse-item" href="#">Nieopłacone</a>
                <a class="collapse-item" href="#">Dłużnicy</a>
                <a class="collapse-item" href="#">Utwórz</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="#">Najnowsi</a>
                <a class="collapse-item" href="#">Niekatywni</a>
                <div class="collapse-divider"></div>
                <h6 class="collapse-header">Zarządzanie</h6>
                <a class="collapse-item" href="404.html">Usuwanie</a>
                <a class="collapse-item" href="blank.html">Edycja</a>
            </div>
        </div>
    </li>
